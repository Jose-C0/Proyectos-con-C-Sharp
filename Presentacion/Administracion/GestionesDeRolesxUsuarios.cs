...
{
    public partial class GestionesDeRolesxUsuarios : Form
    {
        public GestionesDeRolesxUsuarios()
        {
            InitializeComponent();
        }
        ...
        private void GestionesDeRolesxUsuarios_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'gestionVeterinariaDataSet.Rol' table. You can move, or remove it, as needed.
            this.rolTableAdapter.Fill(this.gestionVeterinariaDataSet.Rol);
